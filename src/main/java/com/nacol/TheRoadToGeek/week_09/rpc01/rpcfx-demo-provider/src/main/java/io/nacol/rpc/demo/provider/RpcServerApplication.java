...
import io.nacol.rpc.api.ServiceProviderDesc;
import io.nacol.rpc.demo.api.OrderService;
import io.nacol.rpc.demo.api.UserService;
import io.nacol.rpc.demo.provider.service.OrderServiceImpl;
import io.nacol.rpc.demo.provider.service.UserServiceImpl;
...
//		registerService(client, orderService);
	...
	@Bean(name = "io.nacol.rpc.demo.api.UserService")
	public UserService createUserService(){
		return new UserServiceImpl();
	}

	@Bean(name = "io.nacol.rpc.demo.api.OrderService")
